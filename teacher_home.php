    ...
    <ul class="navbar-nav ml-auto nav-flex-icons">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right"
          ...
          <a class="dropdown-item" href="change_pass.php?id=<?php echo $row['aid']?>" id="<?php echo $aid; ?>"><i class="fas fa-key"></i>&nbsp;&nbsp;Change Password</a>
          <a class="dropdown-item" href="#logout1" data-toggle="modal" data-target="#logout1"><i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp;Logout</a>
        </div>
        <div class="modal fade" id="logout1" tabindex="-1" role="dialog" aria-labelledby="modal1-label">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-9" id="col2">
          <div class="alert alert-info" id="pop" style="margin-top: -50px; width: 90%;">
